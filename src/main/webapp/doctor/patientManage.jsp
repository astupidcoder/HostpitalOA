...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,url:'${pageContext.request.contextPath}/doctor/look.do?userNo='+${currentUser.userNo}
    ...
    ,cols: [[
     ...
     /*  {field:'officeName', width:180, align:'center',title: '科室',templet:function(d){
        ...
        {field:'email', width:200,align:'center', title: '邮箱',templet: '#emailTpl'
        },
        {field:'date', width:200,align:'center', title: '挂号时间',templet:'<div>{{dateToStr(d.date)}}</div>'
        },
